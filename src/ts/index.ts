...
Pebble.addEventListener('webviewclosed', (e: any) => {
  ...
  dict.SnoozeSec = parseInt(s.SnoozeSec, 10) || 0;
  ...
  window.localStorage.setItem('snooze_sec', String(dict.SnoozeSec));
  console.log('Sending TimerConfig: ' + JSON.stringify(dict.TimerConfig) + ' sort=' + dict.SortOrder + ' autoReturn=' + dict.AutoReturn + ' runningFirst=' + dict.RunningFirst + ' idleExit=' + dict.IdleExitSec + ' snooze=' + dict.SnoozeSec);
